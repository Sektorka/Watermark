...
void wxC6F36InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/Watermark_watermark_bitmaps.cpp$C__Users_krisz_ClionProjects_Watermark_Watermark_watermark_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/Watermark_watermark_bitmaps.cpp$C__Users_krisz_ClionProjects_Watermark_Watermark_watermark_bitmaps.xrc"));
}
